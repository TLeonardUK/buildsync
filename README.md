...
## About buildsync
Buildsync is a simple windows tool for distributing package builds, binaries and tools across internal LAN networks. It's primarily focused on the needs of game developers, and is active use on various large projects.
...
* Support for spreading downloads across multiple locations (drives / network shares).
* Support for starting installation of builds remotely (for example a VPN user can trigger an office computer to install console packages to devkits).
