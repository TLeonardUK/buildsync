...
namespace BuildSync.Client.Forms
{
    ...
    public partial class LicenseForm : Form
    {
        ...
        private void LicenseInfoRecieved(License LicenseInfo)
        {
            ...
            expirationLabel.Text = LicenseInfo.ExpirationTime == License.InfiniteExpirationTime ? "Never" : LicenseInfo.ExpirationTime.ToString("r");
        }
